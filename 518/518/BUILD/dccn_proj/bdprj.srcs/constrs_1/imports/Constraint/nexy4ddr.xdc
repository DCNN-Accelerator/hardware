...
#set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports in_switch]; #IO_L21P_T3_DQS_14 Sch=sw[15]
...
#set_property -dict {PACKAGE_PIN D14 IOSTANDARD LVCMOS33} [get_ports conv_bram_rts]
#set_property -dict {PACKAGE_PIN F16 IOSTANDARD LVCMOS33} [get_ports conv_bram_rtr]
#set_property -dict {PACKAGE_PIN G16 IOSTANDARD LVCMOS33} [get_ports bram_conv_rts]; #IO_L13N_T2_MRCC_15 Sch=jb[3]
#set_property -dict {PACKAGE_PIN H14 IOSTANDARD LVCMOS33} [get_ports dac_sclk_0]
...
#set_property -dict { PACKAGE_PIN E7    IOSTANDARD LVCMOS33 } [get_ports JC4]; #IO_L6P_T0_35 Sch=jc[7]
#set_property -dict { PACKAGE_PIN J3    IOSTANDARD LVCMOS33 } [get_ports JC5]; #IO_L22P_T3_35 Sch=jc[8]
#set_property -dict { PACKAGE_PIN J4    IOSTANDARD LVCMOS33 } [get_ports JC6]; #IO_L21P_T3_DQS_35 Sch=jc[9]
#set_property -dict { PACKAGE_PIN E6    IOSTANDARD LVCMOS33 } [get_ports JC7]; #IO_L5P_T0_AD13P_35 Sch=jc[10]
...
#set_property -dict { PACKAGE_PIN G4    IOSTANDARD LVCMOS33 } [get_ports JD5]; #IO_L20P_T3_35 Sch=jd[8]
#set_property -dict { PACKAGE_PIN G2    IOSTANDARD LVCMOS33 } [get_ports JD6]; #IO_L15N_T2_DQS_35 Sch=jd[9]
#set_property -dict { PACKAGE_PIN F3    IOSTANDARD LVCMOS33 } [get_ports JD7]; #IO_L13N_T2_MRCC_35 Sch=jd[10]
